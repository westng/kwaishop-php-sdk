...
Usage:
  php tests/manual/api_call.php call <method> <params_json> [access_token] [version]
...
Examples:
  ...
  php tests/manual/api_call.php call open.item.list '{"pageSize":20,"pageNum":1}' YOUR_ACCESS_TOKEN 1
